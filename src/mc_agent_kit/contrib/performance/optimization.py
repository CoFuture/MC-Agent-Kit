...
class CodeGenOptimizer:
    ...
    def __init__(self, config: OptimizationConfig | None = None):
        ...
        self._template_keys: dict[str, set[str]] = {}  # template -> set of cache keys
    ...
    def generate_with_cache(
        ...
        # 存储模板到缓存键的映射
        if template not in self._template_keys:
            self._template_keys[template] = set()
        self._template_keys[template].add(key)
    ...
    def invalidate_cache(self, template: str | None = None) -> int:
        ...
        keys_to_remove = self._template_keys[template]
        ...
        del self._template_keys[template]
